...
//                        .add(this.area.getTextAreas().get(filePath)
////                             getTextAreas().iterator().next()
//                             )
//                       );
    }
...
//        if(!saved) {
//            out.save(out.getOut().get(tabPane.getSelectedIndex()), area.getTextAreas().
//                     get(tabPane.getTitleAt(0)));
//        }
